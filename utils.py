...
def save_image(image, folder):
    ...
    print('saved original, filename ', filename)
    # compress
    filename = compress_image(filename=filename, folder=folder)
    print('saved compressed, filename ', filename)
    return filename
...
def compress_image(filename, folder):
    ...
    # quality from 1 to 100, default 75, 95 and higher are meaningless, 1 is lowest
